...
describe Puppet::SSL::Host do
  ...
  context "ruby", :unless => RUBY_PLATFORM == 'java' do
    ...
    it "should pass the verification of its own SSL store", :unless => Puppet.features.microsoft_windows? || RUBY_PLATFORM == 'java' do
      @host.generate
