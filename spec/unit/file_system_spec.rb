...
describe "Puppet::FileSystem" do
  ...
  context '#absolute?' do
    ...
    it "returns true for an absolute string" do
      expect(Puppet::FileSystem.absolute?(dest)).to eq(true)
    end

    it "returns true if given an absolute pathname" do
      expect(Puppet::FileSystem.absolute?(Pathname.new(dest))).to eq(true)
    end

    it "returns false if given nil" do
      expect(Puppet::FileSystem.absolute?(nil)).to eq(false)
    end
