...
describe 'Puppet::Pops::Parser::Lexer::Locator' do
  ...
  context 'when computing line from offset' do
    it "should report lines without offset when leading is all 0" do
    ...
    it "should report lines with offset when leading line is not 0" do
  ...
  context 'when computing position on line' do
    it "should report pos without offset when leading is all 0" do
      locator = Puppet::Pops::Parser::Lexer::Locator.new("012\n012\n012\n", @multibyte)
    ...
    it "should report pos with offset when leading per line is not 0" do
      leading_line_count = 10
      leading_offset = 100
