...
describe Puppet::Pops::Impl::Parser::Lexer::Token do
  before do
...
describe Puppet::Pops::Impl::Parser::Lexer::Token, "when initializing" do
  it "should create a regex if the first argument is a string" do
    Puppet::Pops::Impl::Parser::Lexer::Token.new("something", :NAME).regex.should == %r{something}
  end

  it "should set the string if the first argument is one" do
    Puppet::Pops::Impl::Parser::Lexer::Token.new("something", :NAME).string.should == "something"
  end

  it "should set the regex if the first argument is one" do
    Puppet::Pops::Impl::Parser::Lexer::Token.new(%r{something}, :NAME).regex.should == %r{something}
  end
end

describe Puppet::Pops::Impl::Parser::Lexer::TokenList do
  before do
    @list = Puppet::Pops::Impl::Parser::Lexer::TokenList.new
  end
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS do
  before do
    @lexer = Puppet::Pops::Impl::Parser::Lexer.new
  end
...
#    :LBRACE => '{',
    ...
    it "should have a token named #{name.to_s}" do
      Puppet::Pops::Impl::Parser::Lexer::TOKENS[name].should_not be_nil
    end

    it "should match '#{string}' for the token #{name.to_s}" do
      Puppet::Pops::Impl::Parser::Lexer::TOKENS[name].string.should == string
    end
  end
...
#    "import" => :IMPORT, # done as a function in egrammar
    ...
    it "should have a keyword named #{name.to_s}" do
      Puppet::Pops::Impl::Parser::Lexer::KEYWORDS[name].should_not be_nil
    end

    it "should have the keyword for #{name.to_s} set to #{string}" do
      Puppet::Pops::Impl::Parser::Lexer::KEYWORDS[name].string.should == string
    end
  end
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:CLASSREF] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:CLASSREF] }
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:NAME] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:NAME] }
  ...
  it "should return itself and the value if the matched term is not a keyword" do
    Puppet::Pops::Impl::Parser::Lexer::KEYWORDS.expects(:lookup).returns(nil)
  ...
  it "should return the keyword token and the value if the matched term is a keyword" do
    ...
    Puppet::Pops::Impl::Parser::Lexer::KEYWORDS.expects(:lookup).returns(keyword)
  ...
  it "should return the BOOLEAN token and 'true' if the matched term is the string 'true'" do
    ...
    Puppet::Pops::Impl::Parser::Lexer::KEYWORDS.expects(:lookup).returns(keyword)
    @token.convert(stub('lexer'), "true").should == [Puppet::Pops::Impl::Parser::Lexer::TOKENS[:BOOLEAN], true]
  end

  it "should return the BOOLEAN token and 'false' if the matched term is the string 'false'" do
    keyword = stub 'keyword', :name => :FALSE
    Puppet::Pops::Impl::Parser::Lexer::KEYWORDS.expects(:lookup).returns(keyword)
    @token.convert(stub('lexer'), "false").should == [Puppet::Pops::Impl::Parser::Lexer::TOKENS[:BOOLEAN], false]
  end
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:NUMBER] do
  before do
    @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:NUMBER]
    @regex = @token.regex
  end
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:COMMENT] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:COMMENT] }
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:MLCOMMENT] do
  before do
    @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:MLCOMMENT]
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:RETURN] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:RETURN] }
...
describe "the horrible deprecation / compatibility variables with dashes" do
  ...
  { Puppet::Pops::Impl::Parser::Lexer::TOKENS[:DOLLAR_VAR_WITH_DASH] => '$',
    Puppet::Pops::Impl::Parser::Lexer::TOKENS[:VARIABLE_WITH_DASH]   => ''
    ...
    describe token do
      ...
      context "when compatibly is disabled" do
        ...
        Puppet::Pops::Impl::Parser::Lexer::TOKENS.each do |name, value|
...
describe Puppet::Pops::Impl::Parser::Lexer,"when lexing strings" do
  {
...
describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:DOLLAR_VAR] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:DOLLAR_VAR] }
  ...
  it "should return the VARIABLE token and the variable name stripped of the '$'" do
    @token.convert(stub("lexer"), "$myval").should == [Puppet::Pops::Impl::Parser::Lexer::TOKENS[:VARIABLE], "myval"]
  end
end

describe Puppet::Pops::Impl::Parser::Lexer::TOKENS[:REGEX] do
  before { @token = Puppet::Pops::Impl::Parser::Lexer::TOKENS[:REGEX] }
...
describe Puppet::Pops::Impl::Parser::Lexer, "when lexing comments" do
  before { @lexer = Puppet::Pops::Impl::Parser::Lexer.new }
...
describe "Puppet::Pops::Impl::Parser::Lexer in the old tests" do
  before { @lexer = Puppet::Pops::Impl::Parser::Lexer.new }
...
describe "Puppet::Pops::Impl::Parser::Lexer in the old tests when lexing example files" do
