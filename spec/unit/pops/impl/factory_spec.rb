...
describe Puppet::Pops::Impl::Model::Factory do
  ...
  context "When factory methods are invoked they should produce expected results" do
    it "tests #var should create a VariableExpression" do
      var('a').current.class.should == Puppet::Pops::API::Model::VariableExpression
    end

    it "tests #fqn should create a QualifiedName" do
      fqn('a').current.class.should == Puppet::Pops::API::Model::QualifiedName
    end

    it "tests #QNAME should create a QualifiedName" do
      QNAME('a').current.class.should == Puppet::Pops::API::Model::QualifiedName
    end

    it "tests #QREF should create a QualifiedReference" do
      QREF('a').current.class.should == Puppet::Pops::API::Model::QualifiedReference
    end
    ...
    it "should create a literal undef on :undef" do
      literal(:undef).current.class.should == Puppet::Pops::API::Model::LiteralUndef
    end

    it "should create a literal default on :default" do
      literal(:default).current.class.should == Puppet::Pops::API::Model::LiteralDefault
    end
  end
  ...
  context "When calling block_or_expression" do
    ...
    it "Multiple expressions should produce a block expression" do
      ...
      built.is_a?(Puppet::Pops::API::Model::BlockExpression).should == true
  ...
  context "When processing calls with CALL_NAMED" do
    it "Should be possible to state that r-value is required" do
      ...
      built.is_a?(Puppet::Pops::API::Model::CallNamedFunctionExpression).should == true
    ...
    it "Should produce a call expression without arguments" do
      ...
      built.is_a?(Puppet::Pops::API::Model::CallNamedFunctionExpression).should == true
      built.functor_expr.is_a?(Puppet::Pops::API::Model::QualifiedName).should == true
    ...
    it "Should produce a call expression with one argument" do
      ...
      built.arguments[0].is_a?(Puppet::Pops::API::Model::ArithmeticExpression).should == true
    end
    ...
    it "Should produce a call expression with two arguments" do
      ...
      built.arguments[0].is_a?(Puppet::Pops::API::Model::ArithmeticExpression).should == true
      built.arguments[1].is_a?(Puppet::Pops::API::Model::ArithmeticExpression).should == true
    end
  end
  ...
  context "When creating attribute operations" do
    it "Should produce an attribute operation for =>" do
      ...
      built.is_a?(Puppet::Pops::API::Model::AttributeOperation)
      built.operator.should == :'=>'
      built.attribute_name.should == "aname"
      built.value_expr.is_a?(Puppet::Pops::API::Model::LiteralString).should == true
    end
  ...
  context "When processing RESOURCE" do
    it "Should create a Resource body" do
      ...
      built.is_a?(Puppet::Pops::API::Model::ResourceBody).should == true
      built.title.is_a?(Puppet::Pops::API::Model::LiteralString).should == true
      built.operations.size.should == 1
      built.operations[0].class.should == Puppet::Pops::API::Model::AttributeOperation
    ...
    it "Should create a RESOURCE without a resource body" do
      ...
      built.class.should == Puppet::Pops::API::Model::ResourceExpression
  ...
  context "When processing simple literals" do
    it "Should produce a literal boolean from a boolean" do
      ...
      built.class.should == Puppet::Pops::API::Model::LiteralBoolean
  ...
  context "When processing COLLECT" do
    it "should produce a virtual query" do
      ...
      built.class.should == Puppet::Pops::API::Model::VirtualQuery
      built.expr.class.should == Puppet::Pops::API::Model::ComparisonExpression
      built.expr.operator.should ==  :'=='
    end

    it "should produce an export query" do
      built = EXPORTED_QUERY(fqn('a') == literal(1)).current
      built.class.should == Puppet::Pops::API::Model::ExportedQuery
      built.expr.class.should == Puppet::Pops::API::Model::ComparisonExpression
      built.expr.operator.should ==  :'=='
    end
    ...
    it "should produce a collect expression" do
      ...
      built.class.should == Puppet::Pops::API::Model::CollectExpression
      built.operations.size.should == 1
    end
  ...
  context "When processing concatenated string(iterpolation)" do
    it "should handle 'just a string'" do
      ...
      built.class.should == Puppet::Pops::API::Model::ConcatenatedString
      built.segments.size == 1
      built.segments[0].class.should == Puppet::Pops::API::Model::LiteralString
    ...
    it "should handle one expression in the middle" do
      ...
      built.segments[0].class.should == Puppet::Pops::API::Model::LiteralString
      built.segments[0].value.should == "blah blah"
      built.segments[1].class.should == Puppet::Pops::API::Model::TextExpression
      built.segments[1].expr.class.should == Puppet::Pops::API::Model::ArithmeticExpression
      built.segments[2].class.should == Puppet::Pops::API::Model::LiteralString
    ...
    it "should handle only one expression" do
      ...
      built.class.should == Puppet::Pops::API::Model::ConcatenatedString
      built.segments.size == 1
      built.segments[0].class.should == Puppet::Pops::API::Model::TextExpression
      built.segments[0].expr.class.should == Puppet::Pops::API::Model::ArithmeticExpression
    end
  ...
  context "When processing instance / resource references" do
    it "should produce an InstanceReference without a reference" do
      ...
      built.class.should == Puppet::Pops::API::Model::InstanceReferences
  ...
  context "When processing UNLESS" do
    it "should create an UNLESS expression with then part" do
      ...
      built.class.should == Puppet::Pops::API::Model::UnlessExpression
      built.test.class.should == Puppet::Pops::API::Model::LiteralBoolean
      built.then_expr.class.should == Puppet::Pops::API::Model::LiteralNumber
      built.else_expr.class.should == Puppet::Pops::API::Model::Nop
    end
    ...
    it "should create an UNLESS expression with then and else parts" do
      ...
      built.test.class.should == Puppet::Pops::API::Model::LiteralBoolean
      built.then_expr.class.should == Puppet::Pops::API::Model::LiteralNumber
      built.else_expr.class.should == Puppet::Pops::API::Model::LiteralNumber
    end
  end
  ...
  context "When processing IF" do
    it "should create an IF expression with then part" do
      ...
      built.class.should == Puppet::Pops::API::Model::IfExpression
      built.test.class.should == Puppet::Pops::API::Model::LiteralBoolean
      built.then_expr.class.should == Puppet::Pops::API::Model::LiteralNumber
      built.else_expr.class.should == Puppet::Pops::API::Model::Nop
    end
