...
ALGORITHMS_TO_TRY.each do |algo|
  describe "when using digest_algorithm #{algo || 'nil'}" do
    before do
      ...
      @checksums = {
        'md5'    => 'fc6cc9dd1686e807ef82342283da5dfe',
        'sha256' => '7a7b5af52a7f4ee2cbcf8cea85b8a63ebe9265da9f05ba86c038f1002ba11056',
      }
      @dirs      = {
        'md5'    => 'f/c/6/c/c/9/d/d/fc6cc9dd1686e807ef82342283da5dfe',
        'sha256' => '7/a/7/b/5/a/f/5/7a7b5af52a7f4ee2cbcf8cea85b8a63ebe9265da9f05ba86c038f1002ba11056',
      }
