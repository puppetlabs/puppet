...
ALGORITHMS_TO_TRY.each do |algo|
  describe "using digest_algorithm #{algo || 'nil'}" do
    ...
    before do
      ...
      @plaintext = "stuff\r\n"
      @checksums = {
        'md5'    => 'fc777c0bc467e1ab98b4c6915af802ec',
        'sha256' => '9ceaa88afa09577f730665793ee17c914095a66a6f0b108d10243cded5b7faf0',
      }
      @dirs = {
        'md5'    => 'f/c/7/7/7/c/0/b/fc777c0bc467e1ab98b4c6915af802ec',
        'sha256' => '9/c/e/a/a/8/8/a/9ceaa88afa09577f730665793ee17c914095a66a6f0b108d10243cded5b7faf0',
      }
    ...
    describe "when servicing a save request" do
      describe "when supplying a path" do
        it "should store the path if not already stored" do
          ...
          IO.binread("#{dir_path}/contents").should == @plaintext
