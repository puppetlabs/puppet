...
describe "puppet module build" do
  ...
  describe "when called without any options" do
    ...
    it "if current directory or parents contain no module root, should return exception" do
      ...
      expect { subject.build }.to raise_error RuntimeError, "Unable to find metadata.json in module root /a/b/c or parent directories. See <https://docs.puppet.com/puppet/latest/reference/modules_publishing.html> for required file format."
    end
  end
  ...
  describe "when called with a path" do
    ...
    it "if path is not a module root should raise exception" do
      ...
      expect { subject.build('/a/b/c') }.to raise_error RuntimeError, "Unable to find metadata.json in module root /a/b/c or parent directories. See <https://docs.puppet.com/puppet/latest/reference/modules_publishing.html> for required file format."
    end
  end
