...
if RUBY_VERSION < "1.9.3"
  raise LoadError, _("Puppet #{Puppet.version} requires ruby 1.9.3 or greater.")
end
...
module Puppet
  ...
  if RUBY_VERSION < Puppet::OLDEST_RECOMMENDED_RUBY_VERSION
    Puppet.deprecation_warning(_("Support for ruby version #{RUBY_VERSION} is deprecated and will be removed in a future release. See https://docs.puppet.com/puppet/latest/system_requirements.html#ruby for a list of supported ruby versions."))
  end
