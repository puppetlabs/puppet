...
#
class Puppet::Pops::Impl::Validation::Checker3_1
  ...
  def initialize(diagnostics_producer)
    @@check_visitor       ||= Puppet::Pops::API::Visitor.new(nil, "check", 0, 0)
    @@rvalue_visitor      ||= Puppet::Pops::API::Visitor.new(nil, "rvalue", 0, 0)
    @@hostname_visitor    ||= Puppet::Pops::API::Visitor.new(nil, "hostname", 1, 1)
    @@assignment_visitor  ||= Puppet::Pops::API::Visitor.new(nil, "assign", 0, 1)
    @@query_visitor       ||= Puppet::Pops::API::Visitor.new(nil, "query", 0, 0)
    @@top_visitor         ||= Puppet::Pops::API::Visitor.new(nil, "top", 1, 1)
    @@relation_visitor    ||= Puppet::Pops::API::Visitor.new(nil, "relation", 1, 1)
