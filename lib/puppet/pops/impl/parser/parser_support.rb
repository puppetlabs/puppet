...
class Puppet::Pops::Impl::Parser::Parser
  ...
  # Initializes the parser support by creating a new instance of {Puppet::Pops::Impl::Parser::Lexer}
  # @return [void]
  #
  def initvars
