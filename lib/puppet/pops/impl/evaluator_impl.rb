...
# @api private
#
class Puppet::Pops::Impl::EvaluatorImpl < Puppet::Pops::API::Evaluator
  ...
  def initialize
    ...
    @call_operator    ||= Puppet::Pops::Impl::CallOperator.new
    @compare_operator ||= Puppet::Pops::Impl::CompareOperator.new
  end
