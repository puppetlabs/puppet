...
# infer the type by simply looking at the inheritance hierarchy. The {Types::TypeCalculator} should
# be used to answer questions about types. The {Types::TypeFactory} should be used to create an instance
  ...
  class PAnyType < TypedModelObject
    ...
    def assignable?(o)
      case o
        ...
        _assignable?(Types::TypeCalculator.singleton.type(o))
      when PUnitType
        true
      when PVariantType
    ...
    # an instance of Types::PVariantType will return 'Variant'
    ...
    def to_s
      Types::TypeCalculator.string(self)
    end
