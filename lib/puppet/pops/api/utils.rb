...
module Puppet::Pops::API::Utils
  ...
  def self.is_numeric?(o)
    ...
    when Numeric, Integer, Fixnum, Float
      ...
      !!Puppet::Pops::API::Patterns::NUMERIC.match(relativize_name(o.to_s))
    end
  end
  ...
  def self.to_n_with_radix o
    begin
      case o
      when String
        match = Puppet::Pops::API::Patterns::NUMERIC.match(relativize_name(o))
        if !match
          nil
