...
class Puppet::Pops::Evaluator
  ...
  # @param scope [Object] the runtime specific scope to evaluate in
  ...
  def evaluate(o, scope, &block)
    raise NotImplementedError, "A concrete Evaluator implementation should have implemented this method."
  end
end
