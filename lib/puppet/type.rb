...
class Type
  ...
  newmetaparam(:noop) do
    desc "Whether to apply this resource in noop mode.
      ...
      **Important note:**
      [The `noop` setting](https://docs.puppet.com/puppet/latest/reference/configuration.html#noop)
  ...
  newmetaparam(:schedule) do
    desc "A schedule to govern when Puppet is allowed to manage this resource.
      ...
      [the docs for the `schedule` type](https://docs.puppet.com/puppet/latest/reference/type.html#schedule)
      for more info.
  ...
  newmetaparam(:require, :parent => RelationshipMetaparam, :attributes => {:direction => :in, :events => :NONE}) do
    desc "One or more resources that this resource depends on, expressed as
      [resource references](https://docs.puppet.com/puppet/latest/reference/lang_data_resource_reference.html).
      ...
      * The required resource(s) will be applied **before** this resource.
      ...
      [the language page on relationships](https://docs.puppet.com/puppet/latest/reference/lang_relationships.html)."
  end
  ...
  newmetaparam(:stage) do
    desc %{Which run stage this class should reside in.
      ...
      * Declare the new stage as a [`stage` resource](https://docs.puppet.com/puppet/latest/reference/type.html#stage).
