...
require_relative '../puppet/util/execution_stub'
require 'uri'
require 'pathname'
require 'ostruct'
...
module Puppet
module Util
  require_relative '../puppet/util/monkey_patches'
  require 'benchmark'
  ...
  require_relative '../puppet/util/windows/process' if Puppet::Util::Platform.windows?
...
require_relative '../puppet/util/metaid'
