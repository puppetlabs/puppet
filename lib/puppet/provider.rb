...
#    end
  ...
  # @comment Document finalize here as it does not exist anywhere (called from transaction if implemented)
  # @!method finalize()
  # @!abstract A subclass may implement this - it is not implemented in the Provider class
  # This method may be implemented by a provider as a final attempt to clean up resources (files, sockets, etc).
  # This method is called regardless of the events generated by the resource.
  # @return [void]
end
