...
EOT
    ...
    :certificate_revocation => {
        ...
        :desc     => <<-'EOT'
          ...
          listed being the intermediate CRL, the last being for the leaf CA.
          ...
          the issuing CA's revocation list, but does not verify the revocation status of
          the issuing CA or any CA above it within the chain of trust.
