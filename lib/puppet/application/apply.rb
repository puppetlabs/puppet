...
* --detailed-exitcodes:
  ...
  When running with --noop (and no resources have been explicitely set to noop => false)
  it will return 0 for no changes (the system would already be in the desired state)
  and it will return 2 if changes would be needed. If there are resources that explicitely
  have noop => false (and hence will effectively run), they will affect the return code
  just normally.
