module Puppet::Rest
  class ServerResolver
    ...
    # Return the appropriate server and port for the current settings
    # @param [Symbol] srv_service the service to check for SRV records
    # @param [String] default_server the fqdn of the server to fall back to
    #                 if no other is found
    # @param [Integer] default_port the port of the server to fall back to
    #                  if no other is found
