...
Puppet::Type.type(:scheduled_task).provide(:win32_taskscheduler) do
  ...
  def trigger
    ...
    task.trigger_count.times do |i|
      ...
      puppet_trigger['minutes_interval'] = trigger['minutes_interval']
      puppet_trigger['minutes_duration'] = trigger['minutes_duration']
  ...
  def translate_hash_to_trigger(puppet_trigger)
    ...
    if puppet_trigger['minutes_interval']
      ...
      self.fail 'Interval must be an integer greater or equal to 0' unless integer_interval >= 0
    ...
    if puppet_trigger['minutes_duration']
      ...
      self.fail 'Duration must be an integer greater or equal to minutes_interval' unless integer_duration >= integer_interval
