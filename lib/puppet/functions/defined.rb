...
# ```
#
# This order requirement refers only to evaluation order. The order of resources in the
# configuration graph (such as with `before` or `require`) does not affect the `defined`
# function's behavior.
#
