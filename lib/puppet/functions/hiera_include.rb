...
#
# > **Deprecation note:** This function is deprecated in favor of the `lookup` function in
# > combination with `include`. While this function continues to work, it does **not**
# > support:
#
...
#     `sites.pp` manifest, outside of any node definitions and below any top-scope
#     variables that Hiera uses in lookups.
...
#         Puppet fails with a compilation error.
# 3.  The optional name of an arbitrary
#     [hierarchy level](https://docs.puppetlabs.com/hiera/latest/hierarchy.html) to insert
#     at the top of the hierarchy. This lets you temporarily modify the hierarchy for a
#     single lookup.
