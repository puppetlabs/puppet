...
class Puppet::Settings
  ...
  require_relative '../puppet/settings/string_setting'
  require_relative '../puppet/settings/enum_setting'
  require_relative '../puppet/settings/symbolic_enum_setting'
  require_relative '../puppet/settings/array_setting'
  require_relative '../puppet/settings/file_setting'
  require_relative '../puppet/settings/directory_setting'
  require_relative '../puppet/settings/file_or_directory_setting'
  require_relative '../puppet/settings/path_setting'
  require_relative '../puppet/settings/boolean_setting'
  require_relative '../puppet/settings/integer_setting'
  require_relative '../puppet/settings/port_setting'
  require_relative '../puppet/settings/terminus_setting'
  require_relative '../puppet/settings/duration_setting'
  require_relative '../puppet/settings/ttl_setting'
  require_relative '../puppet/settings/priority_setting'
  require_relative '../puppet/settings/autosign_setting'
  require_relative '../puppet/settings/config_file'
  require_relative '../puppet/settings/value_translator'
  require_relative '../puppet/settings/environment_conf'
  require_relative '../puppet/settings/server_list_setting'
  require_relative '../puppet/settings/http_extra_headers_setting'
  require_relative '../puppet/settings/certificate_revocation_setting'
  require_relative '../puppet/settings/alias_setting'
