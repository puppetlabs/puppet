...
apply_manifest_on(agents, manifest) do
  ...
  assert_match('notice: /Stage[main]/Foo/Notify[after]: Dependency Exec[test] has failures: true', stdout, "the after dependency must be reported")
  assert_no_match('Class[Foo]', stdout, 'the class should not be mentioned')
  assert_no_match('Stage[Main]', stdout, 'the class should not be mentioned')
end
