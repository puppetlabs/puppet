...
=======
test_name 'utf-8 characters in cached catalog'
...
>>>>>>> 2e7d0576d9a70a21597c3d671f6604120ad86aaa
File {
  ensure => directory,
  mode => "0755",
}
...
PP
  ...
  with_puppet_running_on(master, master_opts, tmpdir) do 
    ...
    step "apply cached catalog"
    result = on(agent, puppet("resource file #{agent_file} ensure=absent"))
    result = on(agent, puppet("catalog apply --terminus json"))
