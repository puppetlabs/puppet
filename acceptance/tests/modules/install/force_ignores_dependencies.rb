...
on master, puppet("module install pmtacceptance-php -v 0.0.2"), :acceptable_exit_codes => [1] do
  assert_output <<-OUTPUT
    ...
    STDERR> \e[1;31mError: Could not install module 'pmtacceptance-php' (v0.0.2)
    STDERR>   No version of 'pmtacceptance-php' will satisfy dependencies
    STDERR>     You specified 'pmtacceptance-php' (v0.0.2)
    STDERR>     'pmtacceptance-apache' (v0.0.1) requires 'pmtacceptance-php' (v0.0.1)
