...
:   Indirector faces expose indirected subsystems of Puppet. These
    ...
    interacts with the Puppet server\'s data. Most of them have
    additional terminuses for various local data models, which are in
    turn used by the indirected subsystem on the Puppet server whenever
...
**download** - Download this node\'s catalog from the Puppet server server.
...
:   **SYNOPSIS**
    ...
    **DESCRIPTION**
    ...
    Retrieves a catalog from the Puppet server and saves it to the local
    yaml cache. This action always contacts the Puppet server and will
...
:   **SYNOPSIS**
    ...
    **NOTES**
    ...
    rest** if you wish to retrieve a catalog from the Puppet server.
